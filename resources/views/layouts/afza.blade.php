    ...
    <div id="app">
        ...
        <div id="main-wrapper" class="overflow-unset">
                    ...
                    <div class="main-bar clearfix ">
                        <div class="container-fluid clearfix">
                            ...
                            <div class="logo-header mostion logo-dark">
                                <a href="/"><img src="/images/logo-text.png" alt=""></a>
                            </div>
                            <!-- Nav Toggle Button -->
                            ...
                            <div class="header-nav navbar-collapse collapse" id="navbarNavDropdown">
                                ...
                                <ul class="nav navbar-nav navbar navbar-left">
                                    <li class="{{ request()->is('menu') ? 'active' : '' }}"><a href="front-home.html">
                                    ...
                                    {{-- <li class=""><a href="front-transactions.html">
                                            ...
                                            Transaction</a></li>
                                    <li class=""><a href="front-booking.html">
                                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                                width="24px" height="24px" viewBox="0 0 24 24" version="1.1"
                                                class="svg-main-icon">
                                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    ...
                                    <li class=""><a href="front-orders_status.html">
                                            ...
                                            Orders Status</a></li>
                                    <li class=""><a href="https://makaanlelo.com/tf_products_007/davur/dashboard/index.html">
                                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                                width="24px" height="24px" viewBox="0 0 24 24" version="1.1"
                                                class="svg-main-icon">
                                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            ...
            <div class="menu-sidebar">
                <div class="contact-box">
                    <ul class="home-nav">
                        ...
                        <li class="nav-item">
                            <a href="front-transactions.html">
                        ...
                        <li class="nav-item">
                            <a href="front-orders_status.html">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                                    height="24px" viewBox="0 0 24 24" version="1.1" class="svg-main-icon">
                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                        <rect x="0" y="0" width="24" height="24" />
                    ...
                    <ul>
                        ...
                        {{-- <li class="nav-item">
                            <a class="nav-link" href="front-people.html">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                                    height="24px" viewBox="0 0 24 24" version="1.1" class="svg-main-icon">
                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="front-wallet.html">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                                    height="24px" viewBox="0 0 24 24" version="1.1" class="svg-main-icon">
                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                        <rect x="0" y="0" width="24" height="24" />
                        ...
                        {{-- <li class="nav-item">
                            <a class="nav-link" href="front-reviews.html">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                                    height="24px" viewBox="0 0 24 24" version="1.1" class="svg-main-icon">
                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                        <polygon points="0 0 24 0 24 24 0 24" />
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="front-setting.html">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                                    height="24px" viewBox="0 0 24 24" version="1.1" class="svg-main-icon">
                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                        <rect x="0" y="0" width="24" height="24" />
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="front-terms_conditions.html">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                                    height="24px" viewBox="0 0 24 24" version="1.1" class="svg-main-icon">
                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                        <rect x="0" y="0" width="24" height="24" />
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="front-login.html">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                                    height="24px" viewBox="0 0 24 24" version="1.1" class="svg-main-icon">
                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                        <rect x="0" y="0" width="24" height="24" />
            ...
            <div class="footer p-0">
                <div class="copyright">
                    <p>Copyright © Designed &amp; Developed by <a href="#"" target="_blank">Afza</a> 2022
                    </p>
                </div>
            </div>
        </div>

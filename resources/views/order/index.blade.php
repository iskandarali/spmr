        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <a href="{{ route('order.create') }}" class="btn btn-primary float-end">Tambah Order</a>
                            ...
                            <tr>
                                ...
                                <td class="text-end">
                                    <a class="btn btn-primary btn-sm"
                                        href="{{ route('order.edit',$order->id) }}">Kemaskini</a>
                                    <button type="button" class="btn btn-outline-danger btn-sm"
                                        onClick='showModel({!! $order->id !!})'>Delete</button>
                                </td>
                            </tr>
                            @php $bil++ @endphp
                            @empty
                            <tr>
                                <td class="text-center" colspan="7">Tiada order</td>
                            </tr>
                            @endforelse
                        </tbody>
                    </table>
